      ...
      <div className="container-custom">
        ...
        <div className="hidden lg:block relative mb-12">
          ...
          <div className="absolute top-1/2 left-0 w-full h-3 bg-gray-200 dark:bg-gray-700 transform -translate-y-1/2 z-0 rounded-full shadow-inner">
            <div 
              className="h-full bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 transition-all duration-1000 ease-out rounded-full relative overflow-hidden"
              ...
              return (
                ...
                >
                  ...
                  <div className="relative mx-auto mb-6">
                    <div className={`relative w-20 h-20 xl:w-24 xl:h-24 rounded-full flex items-center justify-center transition-all duration-500 ${
                      isActive 
                  ...
                  {/* Content Card */}
                  <div className={`bg-white dark:bg-gray-800 rounded-2xl p-4 xl:p-6 shadow-lg border border-gray-100 dark:border-gray-700 hover:shadow-2xl transition-all duration-300 transform ${
                    isActive ? 'ring-2 ring-purple-500 ring-opacity-50 shadow-2xl' : ''
                  }`}>
        ...
        <div className="lg:hidden space-y-6 sm:space-y-8 mb-12">
          ...
          <div className="flex justify-center mb-8">
            <div className="w-2 h-48 sm:h-64 bg-gray-200 dark:bg-gray-700 rounded-full relative shadow-inner">
              <div 
          ...
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={index}
                className={`flex items-start space-x-4 sm:space-x-6 transition-all duration-700 transform ${
              ...
              >
                {/* Icon */}
                <div className={`flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center transition-all duration-500 ${
                  isActive 
                ...
                {/* Content */}
                <div className={`flex-1 bg-white dark:bg-gray-800 rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-100 dark:border-gray-700 transition-all duration-300 ${
                  isActive ? 'ring-2 ring-purple-500 ring-opacity-30 shadow-2xl' : ''
                }`}>
